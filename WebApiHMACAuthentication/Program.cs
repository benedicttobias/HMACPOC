...
namespace WebApiHMACAuthentication {
	class Program {
		...
		static async Task RunAsync() {
			...
			string apiBaseAddress = "http://localhost:62447/";
			...
			HttpResponseMessage response = await client.PostAsync(apiBaseAddress, new StringContent(
				new JavaScriptSerializer().Serialize(order), Encoding.UTF8, "application/json"));
